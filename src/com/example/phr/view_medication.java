...
public class view_medication extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //String [] arrayOfElements= getResources().getStringArray(getResources().getIdentifier("medication_arrays","string" , getPackageName()));
        list = new ArrayList < String > ();
        listInit = new ArrayList < String > ();

        TextView textView2 = (TextView) findViewById(R.id.textView2);
        TextView addNewmedication = (TextView) findViewById(R.id.add_new_medication);
        TextView backmedication = (TextView) findViewById(R.id.back_view_medication);
        medicationViewBy = (Spinner) findViewById(R.id.medication_view_by);
        listview = (ListView) findViewById(R.id.view_medication_list);
        baseElement=medicationViewBy.getItemAtPosition(0).toString() ;
        ...
        try {
            valuesInit = CustomHttpClient.executeHttpPostArray("https://phr-ripudamanflora.rhcloud.com/mobile/view_medication.php", postParametersInit);
        } catch (Exception e) {
        ...
        //Spinner magic
//        iCurrentSelection = medicationViewBy.getSelectedItemPosition();

        medicationViewBy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {@
            Override
...
//        		listview.getChildAt(5-listview.getFirstVisiblePosition());
        		...
        		String view_by = medicationViewBy.getSelectedItem().toString();
                ...
                try {
                    values = CustomHttpClient.executeHttpPostArray("https://phr-ripudamanflora.rhcloud.com/mobile/view_medication.php", postParameters);
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
                ...
                for (int i = 0; i < arr.length(); i++) {
                    try {
                    	if(medicationViewBy.getSelectedItemPosition()==0)
