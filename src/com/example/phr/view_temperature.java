...
public class view_temperature extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView backtemperature = (TextView) findViewById(R.id.back_view_temperature);
        temperatureViewBy = (Spinner) findViewById(R.id.temperature_view_by);
        listview = (ListView) findViewById(R.id.view_temperature_list);
        baseElement=temperatureViewBy.getItemAtPosition(0).toString() ;
        ...
        try {
            valuesInit = CustomHttpClient.executeHttpPostArray("https://phr-ripudamanflora.rhcloud.com/mobile/view_temperature.php", postParametersInit);
        } catch (Exception e) {
        ...
        //Spinner magic
//        iCurrentSelection = temperatureViewBy.getSelectedItemPosition();

        temperatureViewBy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {@
            Override
...
//        		listview.getChildAt(5-listview.getFirstVisiblePosition());
                ...
                try {
                    values = CustomHttpClient.executeHttpPostArray("https://phr-ripudamanflora.rhcloud.com/mobile/view_temperature.php", postParameters);
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
                ...
                for (int i = 0; i < arr.length(); i++) {
                    try {
                    	if(temperatureViewBy.getSelectedItemPosition()==0)
