...
public class view_allergy extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listview = (ListView) findViewById(R.id.view_allergy_list);
        baseElement=allergyViewBy.getItemAtPosition(0).toString() ;
        ...
        try {
            valuesInit = CustomHttpClient.executeHttpPostArray("https://phr-ripudamanflora.rhcloud.com/mobile/view_allergy.php", postParametersInit);
        } catch (Exception e) {
...
//        		listview.getChildAt(5-listview.getFirstVisiblePosition());
                ...
                for (int i = 0; i < arr.length(); i++) {
                    try {
                    	if(allergyViewBy.getSelectedItemPosition()==0)
