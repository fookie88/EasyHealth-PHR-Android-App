...
public class view_blood_pressure extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        blood_pressureViewBy = (Spinner) findViewById(R.id.blood_pressure_view_by);
        listview = (ListView) findViewById(R.id.view_blood_pressure_list);
        baseElement=blood_pressureViewBy.getItemAtPosition(0).toString() ;
        ...
        try {
            valuesInit = CustomHttpClient.executeHttpPostArray("https://phr-ripudamanflora.rhcloud.com/mobile/view_blood_pressure.php", postParametersInit);
        } catch (Exception e) {
...
//        iCurrentSelection = blood_pressureViewBy.getSelectedItemPosition();
        ...
        blood_pressureViewBy.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {@
            Override
...
//        		listview.getChildAt(5-listview.getFirstVisiblePosition());
                ...
                try {
                    values = CustomHttpClient.executeHttpPostArray("https://phr-ripudamanflora.rhcloud.com/mobile/view_blood_pressure.php", postParameters);
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
                ...
                for (int i = 0; i < arr.length(); i++) {
                    try {
                    	if(blood_pressureViewBy.getSelectedItemPosition()==0)
